...
def build_risk_geometry_report(registry_dir: Path) -> dict[str, Any]:
    ...
    for task in CLASSIC_TASKS:
        ...
        tasks[task] = {
            ...
            "selected_fit_addon": risk.get("selected_fit_addon"),
            "full_calibration_addon": risk.get("full_calibration_addon"),
            "anti_shrinkage_applied": risk.get("anti_shrinkage_applied"),
