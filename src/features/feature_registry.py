...
def get_feature_registry() -> list[FeatureSpec]:
    ...
    return [
        ...
        FeatureSpec("open_to_close", "bar_shape", "current bar", True, "Open relative to current close."),
        FeatureSpec("high_to_close", "bar_shape", "current bar", True, "High relative to current close."),
        FeatureSpec("low_to_close", "bar_shape", "current bar", True, "Low relative to current close."),
        FeatureSpec("month_sin", "seasonality", "calendar", True, "Cyclic month sine coordinate."),
        FeatureSpec("month_cos", "seasonality", "calendar", True, "Cyclic month cosine coordinate."),
